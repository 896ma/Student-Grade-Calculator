...
if(percentage>=100){
    document.getElementById("demo2").innerHTML= `Your Grade is A++ .Wonderful😎`;
}
else if(percentage>=80){
    document.getElementById("demo2").innerHTML= `Your Grade is A. Nicely Done 🥰`;
}
else if(percentage>=60){
    document.getElementById("demo2").innerHTML= `Your Grade is B++ 🤗`;
}
else if(percentage>=40){
    document.getElementById("demo2").innerHTML= `Your Grade is B . Well Above Average`;
}
else{
    document.getElementById("demo2").innerHTML= `Better Luck Next time`;
}
}
